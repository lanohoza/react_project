...
const API_URL = `${environment._API}api/v1/notebooks`;


export const getDailyNotebookData = (day: string, infoViewContext: InfoViewActions): Promise<DailyNotebookDto> => {
  return getDataApi<DailyNotebookDto>(`${API_URL}/daily/${day}`, infoViewContext).then(response => {
    return response
  });
};
