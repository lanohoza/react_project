...
interface Prop {
  datasource: StudentsDiseasesDto;
}

const StudentsDiseaseDocument = ({ datasource }: Prop) => {
  return (
    <Document>
      <Page size='A4' style={styles.page}>
        ...
        <View style={styles.section}>
          <Text style={styles.documentTitle}>
            قائمة التلاميذ ذوي الأمراض المزمنة للموسم الدراسي {datasource.yearTitle}
          </Text>
        </View>
        ...
        <View style={tableStyles.table}>
          ...
          {datasource.diseasesStudents &&
            datasource.diseasesStudents?.map((row, index) => (
              <View style={tableStyles.tableRow}>
                <View style={[tableStyles.tableCol, { flexBasis: '43.33%' }]}>
...
export default StudentsDiseaseDocument;
