...
interface Prop {
  datasource: ProfessorsCoordinatorsDto;
}

const ProfessorsCoordinatorsDocument = ({ datasource }: Prop) => {
  return (
    <Document>
      <Page size='A4' style={styles.page}>
        ...
        <View style={styles.section}>
          <Text style={styles.documentTitle}>
            قائمة الأساتذة منسقي المواد للموسم الدراسي {datasource.yearTitle}
          </Text>
        </View>
        ...
        <View style={tableStyles.table}>
          <View style={tableStyles.tableRow}>
            <View style={[tableStyles.tableCol, { flexBasis: '50%' }]}>
              <Text style={tableStyles.tableCellHeader}> المادة </Text>
            </View>
            <View style={[tableStyles.tableCol, { flexBasis: '50%' }]}>
              <Text style={tableStyles.tableCellHeader}> الأستاذ </Text>
            </View>
          </View>
          {datasource.professors &&
            datasource.professors?.map((row, index) => (
...
export default ProfessorsCoordinatorsDocument;
