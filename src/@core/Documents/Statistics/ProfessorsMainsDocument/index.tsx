...
interface Prop {
  datasource: ProfessorsMainsDto;
}

const ProfessorsMainsDocument = ({ datasource }: Prop) => {
  return (
    <Document>
      <Page size='A4' style={styles.page}>
        ...
        <View style={styles.section}>
          <Text style={styles.documentTitle}>
            قائمة الأساتذة الرئيسيين للموسم الدراسي {datasource.yearTitle}
          </Text>
        </View>
...
export default ProfessorsMainsDocument;
