...
interface Prop {
  datasource: StudentsMainsDto;
}

const StudentsMainsDocument = ({ datasource }: Prop) => {
  return (
    <Document>
    <Page size='A4' style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        قائمة التلاميذ مسؤولي الاقسام للموسم الدراسي {datasource.yearTitle}
        </Text>
      </View>
...
export default StudentsMainsDocument;
