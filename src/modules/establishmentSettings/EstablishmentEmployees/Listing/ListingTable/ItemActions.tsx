...
import { useEstablishmentSettingsActionsContext } from '../../../EstablishmentSettingsContextProvider';

const ItemActions = ({ item }) => {
  const { onDelete, onView, onEdit } = useEstablishmentSettingsActionsContext();
