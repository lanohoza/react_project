...
import { getAllHumanToolsCreatedBy } from '@core/services/HumanToolService';
import {
  StyledFormItem,
  StyledInput,
  StyledInputNumber,
...
import OfficialTxtSelect from '../../administration/technicalCardsAdmin/AddEditTechnicalCard/OfficialTxtSelect';
...
const AddEditTechnicalCard = () => {
  ...
  const loadGeneralObjectives = () => {
    getAllGeneralObjectivesCreatedBy(infoViewActionsContext)
  ...
  const loadHumanTools = () => {
    getAllHumanToolsCreatedBy(infoViewActionsContext)
  ...
  const onFinish = async (values: any) => {
    ...
    if (modeAddEditViewModel === ModeComponent.create) {
      ...
      createTechnicalCard(technicalCard, infoViewActionsContext)
        .then(() => {
                    ...
                    <Col span={24}>
                      <StyledFormItem
                        ...
                        rules={[
                          {
                            required: true,
                            message: 'الرجاء حجز مؤشر التحقق  !',
                          },
                        ]}
                      >
                        <TextArea
