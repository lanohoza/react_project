...
import { useFollowupContext, useFollowupActionsContext } from '../FollowupsContextProvider';
...
const SideBar = ({ }) => {
    const { onCreate, setSelectedIdYear } = useFollowupActionsContext();
    const { years } = useFollowupContext();
    const { Option } = Select;
    return (
        <>
