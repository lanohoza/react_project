...
export type DialyActivityContextActions = {
    onView: (model: GetActivityDto) => void;
    reload: () => void;
    onSearch: (e: any) => void;
    onChangePage: (page: number) => void
    setFiltter: (filtter: any) => void
    setOpenActivityReportModal: (open: boolean) => void;

};
export type DialyActivityContextData = {
...
const DialyActivityContext = createContext<DialyActivityContextData>({
...
const DialyActivityActionsContext = createContext<DialyActivityContextActions>({
    onView: (model: GetActivityDto) => { },
    reload: () => { },
    onSearch: (e: any) => { },
...
export const useDialyActivityContext = () => useContext(DialyActivityContext);

export const useDialyActivityActionsContext = () => useContext(DialyActivityActionsContext);

type DialyActivityContextProviderProps = {
    children: ReactNode;
};

const DialyActivityContextProvider: React.FC<DialyActivityContextProviderProps> = ({
    children,
}) => {
    ...
    return (
        ...
        >
            <DialyActivityActionsContext.Provider
                value={{
...
export default DialyActivityContextProvider;
