          ...
          <Row style={{ marginBottom: 20 }}>
            <Col span={24}>
              <table style={{ width: "100%" }}>
                <thead>
                  <tr>
                    <th style={{ fontSize: "12px", textAlign: "center", padding: "5px", border: "1px solid #ddd" }} >المعدل</th>
                ...
                <tbody>
                  <tr>
                    <td style={{ fontSize: "12px", textAlign: "center", padding: "5px", border: "1px solid #ddd" }} >{convertValueToFixed(data?.data?.average)}</td>
                    {headers.map((item: any, index) => (
                      <td key={index} style={{ fontSize: "12px", textAlign: "center", padding: "5px", border: "1px solid #ddd" }} >{convertValueToFixed(data?.data?.averageCategoryCounts?.find((av) => av.category == item)?.count)}</td>
                    ))}
                  </tr>
