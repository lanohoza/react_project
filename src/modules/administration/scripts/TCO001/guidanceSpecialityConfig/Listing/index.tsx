...
import TCO002GuidanceSpecialityConfigTable from './ListingTable/index';


const TCE002ConditionList = () => {
  const { TCO001Page, page } = useTCO002GuidanceSpecialityConfigContext();
  const { onChangePage, onSearch, onCreate } = useTCO002GuidanceSpecialityConfigActionsContext();
  ...
  return (
    <>
      ...
      <TCO002GuidanceSpecialityConfigTable />
