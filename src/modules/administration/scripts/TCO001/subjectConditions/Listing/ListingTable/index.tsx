...
import { useTCO002SubjectConditionContext } from '../../TCO002SubjectConditionsContextProvider';
...
const TCO002SubjectConditionTable = () => {
  const { TCO001Page, loading } = useTCO002SubjectConditionContext();
...
export default TCO002SubjectConditionTable;
