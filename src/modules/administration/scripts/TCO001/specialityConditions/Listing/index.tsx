...
import TCO002SpecialityConditionTable from './ListingTable/index';


const TCE002ConditionList = () => {
  const { TCO001Page, page } = useTCO002SpecialityConditionContext();
  const { onChangePage, onSearch, onCreate } = useTCO002SpecialityConditionActionsContext();
  ...
  return (
    <>
      ...
      <TCO002SpecialityConditionTable />
