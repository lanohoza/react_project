...
import { deleteHumanTool, saveFromAdministration, SaveHumanTool } from '@core/services/HumanToolService';
...
const HumanToolSelect = ({ onChange, items, reload, value, disabled }) => {
    ...
    const onFinish = (values) => {
        ...
        saveFromAdministration(humanTool, infoViewActionsContext).then(() => {
            reload();
